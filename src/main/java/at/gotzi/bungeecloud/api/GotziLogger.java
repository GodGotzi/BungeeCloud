...
public record GotziLogger(Logger logger) {
    ...
    public void info(String msg) {
        this.logger.info(Colors.CYAN + "[" + Colors.GREEN + "Information" + Colors.CYAN + "] " +  Colors.PURPLE + msg + Colors.RESET);
    }

    public void info(String msg, Class<?> cls) {
    ...
    public void warning(String msg) {
        this.logger.info(Colors.RED + "[" +  Colors.YELLOW + "Warning" + Colors.CYAN + "] " +  Colors.PURPLE + msg + Colors.RESET);
    }

    public void warning(String msg, Class<?> cls) {
